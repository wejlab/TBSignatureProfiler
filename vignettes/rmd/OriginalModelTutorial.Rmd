...
# Evaluation
In this tutorial, we will work with HIV and Tuberculosis (TB) gene expression data in a `SummarizedExperiment` format. First of all, we are going to evaluate the performance of all available TB gene signatures whose original models have been included in the package. 
```{r, message=FALSE}
