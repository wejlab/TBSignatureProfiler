...
In order to install the TBSignatureProfiler, run the following code:
>>>>>>> 9dac62228911fa5226a1f7b5ec1f54c7c598a44f
...
=======
Below, we subset the data to compare the enrichment scores for the ACS_COR_16 signature and the Anderson_42 signature. 
>>>>>>> 9dac62228911fa5226a1f7b5ec1f54c7c598a44f
...
```{r all sigs heatmap, message = FALSE, fig.height = 8, fig.width = 10}
>>>>>>> 9dac62228911fa5226a1f7b5ec1f54c7c598a44f
# Colors for gradient
...
=======
One signature at a time can be fed to the `signatureBoxplot` function if only one plot is desired.
>>>>>>> 9dac62228911fa5226a1f7b5ec1f54c7c598a44f
...
DT::datatable(round(ordered_AUC, 4),
              options = list(scrollX = T, pageLength = 10), 
>>>>>>> 9dac62228911fa5226a1f7b5ec1f54c7c598a44f
              rownames = F)
```
