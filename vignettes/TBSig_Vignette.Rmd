...
Now we make a logcounts, CPM and log_cpm assay, and check to ensure that the assays were indeed created.
```{r add assays}
...
```{r all sigs heatmap, message = FALSE}
# Colors for gradient
...
compareAlgs(hivtb_data, annotationColNames = "Disease",
            scale = TRUE, SuppressMessages = FALSE, 
